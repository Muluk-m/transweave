...
export class McpService {
  ...
  private registerTools() {
    ...
    const listProjectTokensSchema = z.object({
    ...
    this.server.registerTool(
      ...
      async (params: z.infer<typeof listProjectTokensSchema>) => {
    ...
    this.server.registerTool(
      ...
      async (params: z.infer<typeof getTokenDetailsSchema>) => {
    ...
    this.server.registerTool(
      ...
      async (params: z.infer<typeof createTokenSchema>) => {
